<template>
    <label class="theme-switch">
        <input type="checkbox" class="theme-switch__checkbox" :checked="!temaOscuro" @change="toggleTema" />
...
/* Estado nocturno (oscuro) — checkbox NO marcado */
...
/* Estado diurno (claro) — checkbox marcado */
